...
class ConsultaMargemAthenasAdmin(admin.ModelAdmin):
    list_display = ('servidor', 'consignataria', 'margem_total', 'margem_disponivel')  # Campos exibidos na lista
    search_fields = ('servidor__nome', 'consignataria__nome')  # Campos pesquisáveis (acessando relacionamentos)

@admin.register(Reserva)
class ReservaAdmin(admin.ModelAdmin):
    list_display = ('contrato', 'valor', 'situacao', 'prazo_inicial', 'prazo_final', 'cadastrado_por')  # Campos exibidos na lista
